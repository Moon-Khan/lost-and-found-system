...
namespace WebApplication1
{
    public partial class WebForm7 : System.Web.UI.Page
    {
        ...
        {
            if (id_box.Text == "" || color_box.Text == "" || descr_box.Text == "" || statuss.Text == "" || location_box.Text == "" || category_box.Text == "")
                return true;
            else
                return false;
        }
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (!IsTextBoxEmpty())
            {
                ...
                if (dr.HasRows == true)
                {
                    ...
                    cmd2.Parameters.AddWithValue("@statuss", statuss.Text);
                    dr.Close();
        ...
        {
            string query = "use lost_found; select * from item where statuss='Found' ; ";
            SqlConnection con = new SqlConnection(conString);
