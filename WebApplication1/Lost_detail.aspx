<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Lost_detail.aspx.cs" Inherits="WebApplication1.WebForm6" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div style="padding: 90px 1px 40px 450px; font-size: 30px;">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            Enter Your Lost Item Details
        </div>
        <div class="main_box1" style="padding: 0px 0px 12px 0px">
             ...
             <div class="box1" style="padding: 1px 1px 1px 90px">
                 <label style="font-size: 22px">&nbsp; Location</label>:&nbsp;
                   <asp:TextBox runat="server"  Height="21px" Width="172px" ID="location_box"></asp:TextBox>
             </div>
        </div>
        ...
        <div class="main_box3">
            <div class="box3" style="padding: 1px 1px 1px 290px; font-size: 22px;">
                <label style="font-size: 25px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Color </label>
                 <asp:TextBox runat="server"  Height="21px" Width="172px" ID="color_box"></asp:TextBox>
            </div>
            <div class="box3" style="padding: 1px 1px 1px 90px">
                <label style="font-size: 22px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Status: 
                </label>
&nbsp;</div>
            <asp:ListBox ID="status_box" runat="server" Height="31px" Width="191px">
        ...
        <br />
        <br />
   <div style="padding: 5px 0px 0px 835px">
